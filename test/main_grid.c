...
int main()
{
	...
	*/
	...
	ISZ_OBJECT_DETACH(l_h1);
	ISZ_OBJECT_DETACH(l_h2);
	ISZ_OBJECT_DETACH(l_h3);
	ISZ_OBJECT_DETACH(l_d);
	ISZ_OBJECT_DETACH(l_l);
	ISZ_OBJECT_DETACH(l_v1);
	ISZ_OBJECT_DETACH(l_v2);
	ISZ_OBJECT_DETACH(l_r);
	ISZ_OBJECT_DETACH(f_a);
	ISZ_OBJECT_DETACH(f_b);
	ISZ_OBJECT_DETACH(f_c);
	ISZ_OBJECT_DETACH(f_d);
	ISZ_OBJECT_DETACH(f_e);
	ISZ_OBJECT_DETACH(f_f);
